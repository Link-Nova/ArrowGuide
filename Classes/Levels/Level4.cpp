...
Level4::Level4(sf::RenderWindow& win)
	:m_pPlayer(NULL)
	, m_pTilemap(NULL)
	, m_pTileLeft(NULL)
	, m_pTileRight(NULL)
...
void Level4::Initialise()
{
	...
	m_pPlayer->Initialise("Media/Images/player.png", 1, sf::Vector2f(672 + 64, 352 + (64 * 2)));
...
void Level4::InitialiseTiles()
{
	...
	const int level[] =
	{
		...
		14,21,21,21,21,21,21,21,21,21,21,21,21,21,21,15,
		14,21,0, 0, 0, 0, 0, 5, 5, 0, 0, 0, 0, 0,21,15,
		14,21,0, 0, 0, 5, 1, 0, 1, 0, 0, 7, 0, 0,21,15,
		14,21,0, 7, 0, 0, 0, 5, 0, 5, 0, 7, 0, 0,21,15,
		14,21,4, 0, 0, 5, 0, 5, 0, 0, 0, 7, 0, 5,21,15,
		14,21,0, 6, 4, 0, 0, 5, 5, 5, 0, 7, 0, 0,21,15,
		14,21,7, 7, 7, 5, 7, 0, 0, 0, 0, 0, 0, 0,21,15,
		14,21,21,21,21,21,21,21,21,21,21,21,21,21,21,15,
		14,21,21,21,21,21,21,21,21,21,21,21,21,21,21,15,
...
void Level4::Update(sf::Time elapsedTime, LevelGUI*& LevelGUI)
{
