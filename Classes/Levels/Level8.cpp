...
Level8::Level8(sf::RenderWindow& win)
	:m_pPlayer(NULL)
	, m_pTilemap(NULL)
	, m_pTileLeft(NULL)
	, m_pTileRight(NULL)
...
void Level8::InitialiseTiles()
{
	...
	const int level[] =
	{
		...
		14,21,21,21,21,21,21,21,21,21,21,21,21,21,21,15,
		14,21,21,21,21, 7, 0, 5, 0, 0,21,21,21,21,21,15,
		14,21,21,21, 0, 1, 0, 0,23, 0, 7,21,21,21,21,15,
		14,21,21,21, 0, 0, 0, 5, 6, 4, 0,21,21,21,21,15,
		14,21,21,21, 0, 0, 0, 5, 5, 0, 0,21,21,21,21,15,
		14,21,21,21, 0, 0, 7, 5, 0, 0, 0,21,21,21,21,15,
		14,21,21,21, 0,24, 0, 0, 0,25,21,21,21,21,21,15,
		14,21,21,21,21,21,21,21,21,21,21,21,21,21,21,15,
		14,21,21,21,21,21,21,21,21,21,21,21,21,21,21,15,
...
void Level8::Update(sf::Time elapsedTime, LevelGUI*& LevelGUI)
{
...
void Level8::draw(sf::RenderTarget& target, sf::RenderStates states) const
{
	// apply the transform
