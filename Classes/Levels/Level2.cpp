...
Level2::Level2(sf::RenderWindow& win)
	:m_pPlayer(NULL)
	, m_pTilemap(NULL)
	, m_pTileLeft(NULL)
	, m_pTileRight(NULL)
...
void Level2::Initialise()
{
	...
	m_pPlayer->Initialise("Media/Images/player.png", pDOWN, sf::Vector2f(32 + (64 * 7), 32 + (64 * 5)));
...
void Level2::InitialiseTiles()
{
	...
	const int level[] =
	{
		...
		14,21,21,21,21,21, 0, 6, 0,21,21,21,21,21,21,15,
		14,21,21,21,21, 0, 0, 1, 0, 0,21,21,21,21,21,15,
		14,21,21,21, 0, 0, 5, 7, 5, 0, 0,21,21,21,21,15,
		14,21,21,21, 0, 0, 0, 7, 0, 0, 0,21,21,21,21,15,
		14,21,21,21, 0, 0, 5, 7, 5, 0, 0,21,21,21,21,15,
		14,21,21,21,21, 0, 0, 2, 0, 4,21,21,21,21,21,15,
		14,21,21,21,21,21, 0, 7, 0,21,21,21,21,21,21,15,
		14,21,21,21,21,21,21,21,21,21,21,21,21,21,21,15,
		14,21,21,21,21,21,21,21,21,21,21,21,21,21,21,15,
	...
	m_pTileDown->Initialise("Media/Images/tileDown.png", 0, sf::Vector2f(1150, 100));
	m_pTileUp = new Tiles(lUP, m_window);
	m_pTileUp->Initialise("Media/Images/tileUp.png", 1, sf::Vector2f(1150, 250));
	...
	m_pTileRight->Initialise("Media/Images/tileRight.png", 2, sf::Vector2f(1150, 550));
}

void Level2::Update(sf::Time elapsedTime, LevelGUI*& LevelGUI)
{
